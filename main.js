...
function myKeydown(e){
	...
	console.log(keyPressed);
		...
		if((keyPressed >=97 && keyPressed<=122)|| (keyPressed >=65 && keyPressed<=90))
            ...
            aplhabetkey();
            document.getElementById("d1").innerHTML="Você pressionou uma tecla de alfabeto";
            ...
            specialkey();
            document.getElementById("d1").innerHTML="Você pressionou uma tecla especial(Ctrl, Slt ou Esc)";
        }
